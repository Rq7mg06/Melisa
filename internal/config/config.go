...
var (
	...
	SupportChat    = getString("SUPPORT_CHAT", "https://t.me/admteamTR")
	SupportChannel = getString("SUPPORT_CHANNEL", "https://t.me/admteamTR")
	StartTime      = time.Now()
	...
	StartImage = getString(
		"START_IMG_URL",
		"https://i.hizliresim.com/pvuzkim.jpg",
	)
	PingImage = getString(
		"PING_IMG_URL",
		"https://i.hizliresim.com/pvuzkim.jpg",
